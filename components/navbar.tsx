...
import {
  ...
  DropdownMenuTrigger,
} from '@/ai-artifacts/components/ui/dropdown-menu';
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from '@/ai-artifacts/components/ui/select';
import { Templates, TemplateId } from '@/ai-artifacts/lib/templates';
              ...
              <SelectGroup>
                ...
                <SelectItem value="auto">
                  <div className="flex items-center space-x-2">
                    <Sparkles className="flex mr-2" width={16} height={16} />
                    <span>Auto</span>
                  </div>
                </SelectItem>
