...
import {
  ...
  TabsList,
  TabsTrigger,
} from '@/ai-artifacts/components/ui/tabs';
import { Button } from '@/ai-artifacts/components/ui/button';
import { Link, Copy } from 'lucide-react';
import { TemplateId } from '@/ai-artifacts/lib/templates';
import { ArtifactSchema } from '../lib/schema';
import { ExecutionResult } from '@/ai-artifacts/app/api/sandbox/route';
...
export function SideView({
  ...
  return (
    <div className="flex-1 flex flex-col shadow-2xl rounded-lg border border-[#FFE7CC] max-w-[800px]">
      <Tabs
        value={selectedTab}
        onValueChange={(value) =>
      ...
      >
        <div className="flex w-full p-2 items-center justify-end bg-[#FAFAFA] rounded-t-lg border-b border-[#FFE7CC]">
